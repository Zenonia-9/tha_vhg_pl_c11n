...
Extend the native Partner Ledger report with Anzer, invoice, and reference columns for Odoo 19.

This addon customizes the original `account_reports` Partner Ledger in place. It adds **Anzer ID**, **Anzer Reference**, and **Invoice No.** columns to move-line rows while keeping the standard report action, menu, filters, unfold behavior, PDF export, and XLSX export intact.

## Highlights

- Adds **Anzer ID**, **Anzer Reference**, **Invoice No.**, and **Reference** columns to the native Partner Ledger.
...
- `models/account_partner_ledger.py`
  Extends the native Partner Ledger query hook to include Anzer and invoice fields from the related journal entry.
